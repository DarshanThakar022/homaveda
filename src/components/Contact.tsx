...
import { Phone, Mail, MessageCircle, Send, Clock, Award } from "lucide-react";
...
${formData.message}
    ...
    const whatsappURL = `https://wa.me/918160333243?text=${encoded}`;
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-green-50 to-amber-50 overflow-x-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-green-600 text-white py-4 px-6 rounded-lg font-semibold hover:bg-green-700 transition duration-200 flex items-center justify-center space-x-2"
              >
                <Send size={20} />
